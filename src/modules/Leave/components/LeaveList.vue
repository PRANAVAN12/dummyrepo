<template>
 ...
 <template v-slot:item.to_date="{ item }">{{
      ...
      <LeaverRequestEdit  @conform="refreshData()" :leave="leaveRequest" :leaveInfo="leaveInfo" ref="leaveRequestEdit"/>
      <LeaveRequestView  @conform="refreshData()" :leave="leaveRequest" ref="leaveRequestview"/>
    </v-container>
  </div>
</template>
...
import LeaverRequest from "./AddLeaveRequest";
import LeaverRequestEdit from "./EditLeaveRequst";
