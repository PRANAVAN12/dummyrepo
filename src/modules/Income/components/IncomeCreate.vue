    ...
    >
      ...
      >
        ...
        <ValidationObserver ref="observer" v-slot="{ validate, reset }">
          ...
          <v-row>
            <v-col cols="6" v-if="Income.type=='Warehouse'">
            ...
            <v-col cols="6" v-if="Income.type=='Shop'">
...
shops:[],
  ...
  methods: {
    ...
    GetIncomeCategoriesByQuery() {
      ...
      this.$store
          ...
          .then((res) => {
            debugger
            console.log(res);
            this.GetIncomeCategories = res.data.data;
    ...
    CreateIncome() {
      ...
      this.$store
          .dispatch(
              "warehouse/createIncome",
              {
                income_for:this.Income.type,
