...
export default {
  ...
  methods: {
    ...
    UpdateOffice() {
      this.isLoading = true;
      const credential = this.Office;

      this.$store
        .dispatch("system/UpdateOffice", {
          data: {
            id: credential.id,
            name: credential.name,
            city: credential.city,
            address_line: credential.address_line,
            open_time: credential.open_time,
            close_time: credential.close_time,
          },
        })
        .then(async (res) => {
          this.succeeed = true;
