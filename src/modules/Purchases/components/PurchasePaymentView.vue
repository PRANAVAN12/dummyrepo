        ...
        <v-col  cols="12" sm="12" md="6" lg="4">
          <v-card class="lighten-12 ">
            ...
            <v-container fluid>
              ...
              <v-row v-if="PaymentDetails.payment_type=='Cheque'&& PaymentDetails.cheque">
              ...
              <v-row>
                <v-col cols="12">
                  <FileUpload
                      ...
                      icon="mdi-upload"
                      autoupload="true"
                      :url="'document/upload/payment/' + this.$route.params.paymentId"
                      :showDocumentView="true"
                      :documentsUrl="'document/payment/'+this.$route.params.paymentId"
...
export default {
  ...
  methods: {
    GetPayment() {
      ...
      this.$store
          .dispatch("purchase/GetPurchasePaymentById", {Id:this.purchaseId,paymentId:this.paymentId})
          .then((res) => {
