  ...
  <div class="limiter">
    <div class="container-login">
      <div class="wrap-login">
        <div class="login-form changepasslayout">
          ...
          <v-btn depressed color="" @click="NotNow()" text class="not-form-btn">
            Not Now?
          </v-btn>
        </div>

        <div class="changepassword-more"></div>
      </div>
    </div>
  </div>
        ...
        <v-row  align="center" justify="center">
          <v-col  cols="12" sm="8" md="4">
            <v-card  class="lighten-12 card-content">
             ...
             <v-card-title class="font-weight-black"> Change Password</v-card-title>
                  <v-container>
                <ValidationObserver ref="observer">
                ...
                <ValidationProvider v-slot="{ errors }" name="Name" rules="required">
                     ...
                     @click:append="() => (value = !value)"
                      ...
                      />
                       ...
                       <v-alert v-if="messages" class="messages" dense outlined type="error"> {{messages}} </v-alert>
                </ValidationObserver>
         </v-container>
              ...
              <v-card-actions>
               ...
               <v-btn text color="ml-1 text-white btn_medium mr-2" @click="NotNow()">Not Now?</v-btn>
              
                <v-btn color="text-white btn_blue btn_medium w-100" @click="ResetPassword()">Login</v-btn>
                 </v-col>
...
export default {
  ...
  methods: {
    ...
    async ResetPassword() {
      ...
      if (isValid && this.form.newPassword == this.form.conformPassword) {
        this.loading = true;
        var userName = this.CryptoJS.AES.decrypt(
          this.$route.query.us,
          "changepassword"
        ...
        this.$store
          .dispatch("user/ChangeTempPassword", {
            ...
            confirm_password: this.form.conformPassword,
            username: userName,
          })
          .then((res) => {
            this.loading = false;
